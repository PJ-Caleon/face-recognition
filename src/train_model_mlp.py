...
np.save(os.path.join(base_dir, "embeddings.npy"), np.array(known_embeddings))
np.save(os.path.join(base_dir, "labels.npy"), np.array(known_names))
print(f"Proceed to MLP training")
